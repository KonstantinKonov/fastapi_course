...
from src.exceptions import check_date_to_after_date_from, ObjectNotFoundException, Hotel404, Room404
...
async def get_rooms(
    ...
    if date_to <= date_from:
        raise HTTPException(status_code=409, detail="wrong data")
